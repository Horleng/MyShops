...
export default function Footer() {
  return (
<footer className="p-4 bg-gray-700 sm:p-6 dark:bg-gray-900">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link className="hover:underline">Flowbite™</Link>. All Rights Reserved.
        </span>
